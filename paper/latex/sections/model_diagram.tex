...
\begin{tikzpicture}[
  ...
  \node[latent]                  (exposurecoef) at (4.7, 0)      {$\beta^{\mathrm{any}}_p\sim\mathcal N(0,0.7^2)$\\$\boldsymbol\beta^{\mathrm{share}}_p\mid\alpha^{\mathrm{gp}}_p,\rho^{\mathrm{gp}}_p$ (HSGP)};
